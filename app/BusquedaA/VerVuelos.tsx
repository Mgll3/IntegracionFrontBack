          ...
          <div className="passengers-container">
            ...
            {showPassengerSelection && (
              <div className="passenger-selection">
                <label className="title-flight"
                >¿Quienes Vuelan?</label>
                <div className="passenger-type">
                  <label className = "title-sits">Adultos</label>
                  <div className="passenger-counter">
                    <button onClick={() => handleAdultChange(Math.max(adults - 1, 0))}>-</button>
                    <span>{adults}</span>
                    <button id="addAdultButton" onClick={() => handleAdultChange(adults + 1)}>+</button>
                  </div>
                </div>
                ...
                <div className="passenger-type">
                  ...
                  <div className="passenger-counter">
                    ...
                    <span>{child}</span>
                    <button id = "addChildButton" onClick={() => handleChildrenChange(child + 1)}>+</button>
                  </div>
                </div>
                ...
                <div className="passenger-type">
                  ...
                  <div className="passenger-counter" >
                    ...
                    <span>{infants}</span>
                    <button id = "addBabyButton" onClick={() => handleInfantsChange(infants + 1)}>+</button>
                  </div>
                </div>
                <label className="sit-description">Menores de 2 años</label>
                <button id = "confirmPassengers" className="confirm-button" onClick={handleConfirm}>Confirmar</button>
              </div>
            )}            
          </div>

          <button id = "submit" type="submit" style={{ display: showMainButtons ? 'inline-block' : 'none' }}>
            Buscar
          </button>
...
<div className="container">
  ...
  <div className="search-history">
    <ul className="search-history-list">
      ...
      {showPrices && <VerPrecios originCity={originCity} destinationCity={destinationCity} adults={adults} child={child} infants={infants} tripType={tripType} departureDate={departureDate} arrivalDate={returnDate} />}
